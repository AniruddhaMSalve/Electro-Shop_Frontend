...
<table align="center" width="40%" class="table-bordered">
	<tr><td colspan="5"><h3 align="center"><b><u>Payment Using Debit Card</u></b></h3></td></tr>
	<tr>
		<td><b>Debit Card</b></td>
		<td input type="text" name="dcard" required="required"/>	
	</tr>
	<tr>
		<td><b>Card Number</b></td>
		<td><input type="text" name="dNo" maxlength="16" required="required"/></td>
	</tr>
	<tr>
		<td><b>Validity</b></td>
		<td><input type="text" name="dvalidity" maxlength="10" required="required"/></td>
	</tr>
	<tr>
		<td><b>CVV</b></td>
		<td><input type="text" name="dcvv" maxlength="3" required="required"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="radio" name="pmode" value="DC" required="required"/></td>
	</tr>
	<tr>
