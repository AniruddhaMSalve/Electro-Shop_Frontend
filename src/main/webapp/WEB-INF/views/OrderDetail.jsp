...
<tr>
	...
	<td>${cartItemList.quantity*cartItemList.price }</td><!-- <td bgcolor="green"><h5><font color="white">Order Confirmed</font></h5></td> -->
</tr>
</c:forEach>
<tr>
...
<tr>
	...
	<td colspan="2"><a href="<c:url value="/Payment"/>" class="btn btn-success">Proceed For Payment</a></td>
</tr>
