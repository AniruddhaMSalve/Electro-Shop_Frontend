	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="Home">Elecrto-Shop</a>
			</div>
			...
			<c:if test="${sessionScope.loggedIn }">
				...
				<li class="active"><a href="<c:url value="/Home"/>">Home</a>
				<li><a href="<c:url value="/ProductCatalog"/>">Product Catalog</a></li>
				<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Manage Database<span class="caret"></span></a>
