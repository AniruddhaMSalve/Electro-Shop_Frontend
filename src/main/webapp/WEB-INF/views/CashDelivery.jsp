...
<table align="center" width="40%" class="table-bordered">
	<tr><td colspan="5"><h3 align="center"><b><u>Payment Using Cash on Delivery</u></b></h3></td></tr>
	<tr>
		<td><b>Your Name</b></td>
		<td><input type="text" name="yname" maxlength="25" required="required"/></td>
	</tr>
	<tr>
		<td><b>Your Address</b></td>
		<td><input type="text" name="yadd" required="required"/></td>
	</tr>
	<tr>
		<td><b>Mobile Number</b></td>
		<td><input type="text" name="mNo" maxlength="10" required="required"/></td>
	</tr>
	<tr>
		<td><b>Alternative Address</b></td>
		<td><input type="text" name="aadd" required="required"/></td>
	</tr>
	<tr>
		<td><b>Agree Terms and Conditions</b></td>
		<td><input type="radio" name="pmode" value="COD" required="required"/></td>
	</tr>
	<tr>
