...
<tr>
	<td colspan="4"><center><b><u>Enter Supplier Details</u></b><br></br></center></td>
</tr>
<tr>
	<td><b>Supplier Name</b></td>
	<td>&nbsp<form:input path="supplierName" required="required"/></td>
</tr>
<tr>
	<td><b>Supplier Address</b></td>
	<td>&nbsp<form:input path="address" required="required"/></td>
</tr>
...
<c:if test="${!flag}">
<form:form action="http://localhost:8080/Electro-Shop_Frontend/UpdateSupplier/${supplier.supplierId}" modelAttribute="supplier" method="post">
<table align="center">
...
<tr><td colspan="5"><center><h3><b>Supplier Details</b></h3></center></td></tr>
<tr>
